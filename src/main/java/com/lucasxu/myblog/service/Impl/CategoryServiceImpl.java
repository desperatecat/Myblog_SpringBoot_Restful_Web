...
import com.lucasxu.myblog.dao.ArticleCategoryMapper;
import com.lucasxu.myblog.dao.CategoryInfoMapper;
...
import com.lucasxu.myblog.entity.CategoryInfoExample;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public ArticleCategoryDto getCategoryByArticleId(Long id) {
        ...
        articleCategoryDto.setArticleId(articleCategory.getArticle_id());
        articleCategoryDto.setId(articleCategory.getId());
        articleCategoryDto.setCategoryId(articleCategory.getCategory_id());
        // 填充对应的分类信息
        CategoryInfo categoryInfo = getOneById(articleCategory.getCategory_id());
